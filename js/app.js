        ...
        <div class="card" onclick="${locked ? `window.showPay('${c.id}', '${c.title.replace(/'/g, "\\'")}')` : `openChecklist('${c.id}')`}">
          <div class="card-row">
            ...
            <div style="text-align:right;">
              ...
              ${locked ? `<div style="font-size:13px;font-weight:600;color:#ff9500;margin-top:4px;white-space:nowrap;display:flex;align-items:center;justify-content:flex-end;gap:2px;">${price}<span style="font-size:10px;">⭐</span></div>` : ''}
            </div>
          </div>
        </div>
      `;
